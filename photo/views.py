...
class PhotoUpdate(UpdateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if object.author != request.user:
            messages.warning(request, 'You don''t have authority to update this post')
...
class PhotoDelete(DeleteView):
    ...
    def dispatch(self, request, *args, **kwargs):
        object = self.get_object()
        if object.author != request.user:
            messages.warning(request, 'You don''t have authority to delete this post')
            return HttpResponseRedirect('/')
        else:
...
class PhotoLikeList(ListView):
    ...
    # Return all the post what user clicked like button
